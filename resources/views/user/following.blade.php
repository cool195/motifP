                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-xs-12 follow-item">
                            <div class="text-center box-shadow p-a-40x m-b-20x @if($key % 4 == 0 || $key % 4 == 3) bg-white @else bg-common @endif">
                                ...
                                <div class="p-t-15x">
                                    <a href="javascript:void(0);" class="btn btn-gray btn-sm p-x-20x btn-follow active" data-did="{{$follow['userId']}}">Follow</a>
                                </div>
...
<template id="tpl-follow">
    ...
    <div class="col-md-6 col-xs-12 follow-item">
        <div class="text-center box-shadow p-a-40x m-b-20x @{{ if ($index % 4) == 0 || ($index % 4) == 3 }} bg-white @{{ else }} bg-common @{{ /if }}">
            ...
            <div class="p-t-15x">
                <a href="javascript:void(0);" class="btn btn-gray btn-sm p-x-20x btn-following active" data-did="@{{ $value.userId }}">Follow</a>
            </div>
