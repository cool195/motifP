...
<section class="body-container m-y-30x">
    <div class="container">
        <div class="myHome-content">
            @include('Other.page-left', ['title' => 'termsconditions'])
            <div class="right">
                <div class="rightContent">
                    <div class="bigNoodle text-center leftMeun-title uppercase">TERMS & CONDITIONS</div>
                    <hr class="hr-black m-t-0">
                    <div class="p-a-30x text-center">
                        ...
                        <p><strong class="avenirBold">If you enter into any other agreement with us, then these
                        ...
                        <p class="avenirBold m-b-15x m-t-20x">1. MODIFICATION TO THESE TERMS</p>
                        ...
                        <p class="avenirBold m-b-15x m-t-20x">3. MEMBERSHIP ELIGIBILITY</p>
                        <p><strong class="avenirBold text-underLine">Age</strong></p>
                        ...
                        <p><strong class="avenirBold text-underLine">Compliance</strong></p>
                        ...
                        <p><strong class="avenirBold text-underLine">User Account and Password</strong></p>
                        ...
                        <p class="avenirBold m-b-15x m-t-20x">4. TRANSACTIONS</p>
                        <p>You agree to pay all charges incurred by you or any users of your
                        ...
                        <p class="avenirBold m-b-15x m-t-20x">6. TERM AND TERMINATION OF USER ACCOUNT</p>
                        ...
                        <p class="avenirBold m-b-15x m-t-20x">7. CONSENT TO MONITORING</p>
                        ...
                        <p class="avenirBold m-b-15x m-t-20x">8. PRIVACY AND USE OF PERSONAL INFORMATION</p>
                        ...
                        <p class="avenirBold m-b-15x m-t-20x">9. POSTING MESSAGES OR CONTENT</p>
                        ...
                        <p class="avenirBold m-b-15x m-t-20x">10. CONSENT TO ELECTRONIC COMMUNICATIONS</p>
                        ...
                        <p class="avenirBold m-b-15x m-t-20x">11. LINKS TO OTHER WEBSITES AND COMPANIES</p>
                        ...
                        <p class="avenirBold m-b-15x m-t-20x">12. PROHIBITED CONDUCT</p>
                        ...
                        <p>You agree not to use Our Services to engage in any prohibited
                            ...
                            or the rights of
                            any third party.</p>
                        <p><strong class="avenirBold">USE OF OUR SERVICES FOR THE FOLLOWING ACTIVITIES IS STRICTLY
                                PROHIBITED:</strong></p>
                        <p><strong class="avenirBold">(a) Harm to Minors.</strong>Using Our Services to harm, or
                            attempt to harm, minors
                            in any way. </p>
                        <p><strong class="avenirBold">(b) Illegal Use.</strong>Using Our Services to transmit any
                            material that,
                            intentionally or unintentionally, violates any applicable local, state, national or
                            international law,
                            or any related rules or regulations.</p>
                        <p><strong class="avenirBold">(c) Invasion of Privacy.</strong> Using Our Services for
                            activities that invade
                            another’s privacy. </p>
                        <p><strong class="avenirBold">(d) Intellectual Property Right Violations. </strong>Using
                        ...
                        <p><strong class="avenirBold">(e) Obscene or Indecent Speech or Materials.</strong>Using
                        ...
                        <p><strong class="avenirBold">(f) Harassment, Defamatory or Abusive Language.</strong>Using
                            Our Services to
                            ...
                            harasses another. </p>
                        <p><strong class="avenirBold">(g) Hacking or Unauthorized Access.</strong>Using Our
                        ...
                        <p><strong class="avenirBold">(h) Distribution of Computer Viruses, Trojan Horses or Other
                        ...
                        <p><strong class="avenirBold">(i) Facilitating a Violation of these Terms.</strong>Using
                        ...
                        <p><strong class="avenirBold">(j) Unsolicited Commercial Email/Unsolicited Bulk
                        ...
                        <p><strong class="avenirBold">(k) Collection of Personal Data.</strong>Using Our Services
                            to collect, or attempt
                            to collect, personal information about third parties or us without their knowledge
                            or consent. </p>
                        <p><strong class="avenirBold">(l) Resale.</strong>The sale, transfer or rental of Our
                            Services to customers,
                            clients or other third parties, either directly or as part of a service or product
                            created for resale.
                        </p>

                        <p class="avenirBold m-b-15x m-t-20x">13. OUR PROPRIETARY RIGHTS</p>
                        ...
                        <p class="avenirBold m-b-15x m-t-20x">14. COPYRIGHT POLICY & PROCESS FOR ALLEGATION OF COPYRIGHT INFRINGEMENT</p>
                        ...
                        <p class="avenirBold m-b-15x m-t-20x">15. DISCLAIMER OF WARRANTIES</p>
                        ...
                        <p class="avenirBold m-b-15x m-t-20x">16. LIMITATION OF LIABILITY; TIME FOR COMMENCING ACTION</p>
                        ...
                        <p class="avenirBold m-b-15x m-t-20x">17. RELEASE</p>
                        ...
                        <p class="avenirBold m-b-15x m-t-20x">18. INDEMNITY</p>
                        ...
                        <p class="avenirBold m-b-15x m-t-20x">19. GOVERNING LAW</p>
                        ...
                        <p class="avenirBold m-b-15x m-t-20x">20. ARBITRATION OF DISPUTES</p>
                        ...
                        <p><strong class="avenirBold">The parties involved in the Dispute expressly intend and
                        ...
                        <p class="avenirBold m-b-15x m-t-20x">21. GENERAL</p>
                        ...
                        <p><strong class="avenirBold">BY USING OUR SERVICES, YOU REPRESENT THAT YOU HAVE THE LEGAL
