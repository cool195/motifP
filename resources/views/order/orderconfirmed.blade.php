...
<section class="m-y-40x">
    <div class="container bg-white text-center">
        <div class="order_comfirmed_content">
            ...
            <p>You can track
                <a data-impr='{{config('runtime.CLK_URL')}}/log.gif?t=order.100001&m=PC_M2016-1&pin={{Session::get('user.pin')}}&uuid={{Session::get('user.uuid')}}&v={"orderno":{{$order['sub_order_no']}},"expid":0,"version":"1.0.1,"src":"PC"}'
