                    ...
                    @if($value['type']=='banner' || (!isset($value['spus']) && $value['type']=='product'))
                        <!--banner图-->
                            <div class="p-y-0 text-center">
                                ...
                                @else
                                    <a href="@if($value['skipType']=='1')/detail/{{$value['skipId']}}@elseif($value['skipType']=='2')/collection/{{$value['skipId']}}@elseif($value['skipType']=='3')/topic/{{$value['skipId']}}@elseif($value['skipType']=='4')/shop#{{$value['skipId']}}@else{{$value['skipId']}}@endif"
                                                        ...
                                                        <a href="/detail/{{$product['spuInfos'][$spu]['spuBase']['seo_link']}}"
                                                           ...
                                                           data-price="{{number_format($product['spuInfos'][$spu]['skuPrice']['sale_price']/100,2)}}">
                                                            <img class="img-fluid img-lazy figure"
                                                                 ...
                                                                 data-original="{{config('runtime.CDN_URL')}}/n0/{{$product['spuInfos'][$spu]['spuBase']['main_image_url']}}"
                                ...
                                <div class="image-container">
                                    <a data-impr="{{ $product['impr'] }}" data-clk="{{ $product['clk'] }}"
                                       ...
                                       data-price="{{number_format($product['skuPrice']['sale_price']/100,2)}}">
                                        <img class="img-fluid img-lazy figure"
                                             data-original="{{config('runtime.CDN_URL')}}/n0/{{$product['main_image_url']}}"
