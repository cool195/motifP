    ...
    <div class="container p-y-30x">
        <div class="row">
            <div class="col-md-4 p-x-20x">
                <div class="text-center"><i class="iconfont icon-user text-main font-size-llxx"></i></div>
                <div class="text-center font-size-lx text-main p-t-20x">Sign up & Register.</div>
            </div>
            <div class="col-md-4 p-x-20x">
                <div class="text-center"><i class="iconfont icon-ticket text-main font-size-llxx"></i></div>
