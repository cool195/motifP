...
<section class="body-container m-y-30x">
    <div class="container">
        <div class="myHome-content">
            @include('Other.page-left', ['title' => 'privacynotice'])
            <div class="right">
                <div class="rightContent">
                    <div class="bigNoodle text-center leftMeun-title uppercase">Privacy Notice</div>
                    <hr class="hr-black m-t-0">
                    <div class="text-center p-a-30x">
                        ...
                        <p class="avenirBold m-b-15x m-t-20x">1. Information We May Collect About
                        ...
                        <p class="avenirBold m-b-15x m-t-20x">2. Information We Collect through
                        ...
                        <p>(a) <strong class="avenirMedium">Cookies (or browser cookies)</strong>. Unless you have adjusted your
                            browser setting so
                        ...
                        <p>(b) <strong class="avenirMedium">Flash Cookies</strong>. Certain features of Our Services may use local
                            stored objects (or
                        ...
                        <p class="avenirBold m-b-15x m-t-20x">3. How We Use Your Information</p>
                        ...
                        <p class="avenirBold m-b-15x m-t-20x">5. Your California Privacy Rights</p>
                        ...
                        <p class="avenirBold m-b-15x m-t-20x">7. Data Security</p>
                        ...
                        <p class="avenirBold m-b-15x m-t-20x">8. Links to Other Websites and Companies</p>
                        ...
                        <p class="avenirBold m-b-15x m-t-20x">9. Social Media Pages</p>
