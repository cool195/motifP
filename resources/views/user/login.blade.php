...
@include('header', ['title' => 'Login', 'cid' =>$cid, 'page' => 'Login'])
<!-- 内容 -->
            ...
            {{--<div class="row">--}}
                ...
                {{--<div class="col-lg-6 bg-white">--}}
                    {{--<div class="login-content">--}}
                        {{--<h4 class="p-t-30x m-b-15x sanBold text-main">SIGN IN</h4>--}}
                        {{--<form id="login">--}}
                            {{--<fieldset class="p-t-15x login-text">--}}
                                {{--<div class="login-text">--}}
                                    {{--<input type="text"--}}
                                           {{--class="input-login form-control contrlo-lg text-primary login-email"--}}
                                           {{--name="email" placeholder="Email">--}}
                                    {{--<i class="iconfont icon-delete font-size-lg input-clear text-common hidden"></i>--}}
                                {{--</div>--}}
                                {{--<div class="warning-info off flex flex-alignCenter text-warning p-t-5x">--}}
                            ...
                            {{--<fieldset class="p-t-15x login-text">--}}
                                {{--<div class="login-text">--}}
                                    {{--<input type="password"--}}
                                           {{--class="input-login form-control contrlo-lg text-primary login-pw" name="pw"--}}
                                           {{--placeholder="Password">--}}
                                    {{--<i class="iconfont icon-show font-size-lg input-show text-common off"></i>--}}
                                {{--</div>--}}
                                {{--<div class="warning-info off flex flex-alignCenter text-warning p-t-5x">--}}
                        ...
                        {{--<div class="p-y-15x text-center">--}}
                            {{--<a class="text-link" href="/forgetpassword">Forgot password?</a>--}}
                        {{--</div>--}}
                        {{--<div class="text-center login-or">--}}
                            {{--<hr class="hr-login m-a-0">--}}
                        ...
                        {{--</div>--}}
                        {{--<div class="p-y-15x text-center">--}}
                            {{--<div class="text-main">Don’t have an account? <a class="text-link"--}}
                                                                             {{--href="/register?referer={{$referer}}">Sign--}}
                                    {{--up</a></div>--}}
                        {{--</div>--}}
                    {{--</div>--}}
                {{--</div>--}}
