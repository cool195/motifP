...
//        b.add("jduid",getCooike("uid")),
            ...
            Ba = function() {
                ...
                var a = new ya,
                    b = xa.get(s);
                xa.set(q,getCookie("uid"));
                console.log(xa.get(q));
                return za(xa, a),
                    m.util.Wv("__jda", ta(xa), b, xa.get(u)),
                    m.util.Wv("__jdu", xa.get(q), b, xa.get(u)),
        ...
        m.util.Nt = Ca,
            m.tracker = {
                ...
                sendNew: function(a, d) {
                    var e = Ca(),
                        f = ("https:" == document.location.protocol ? "https://clk": "http://clk") + ".motif.me/log.gif?t=" + a + "&m=" + xa.get(p) + "&pin=" + c(xa.get(Y)) + "&uuid=" + e.jduid + "&sid=" + e.jdsid + (e.jdak ? "&cul=" + document.location.href + c("&clickid=" + e.jdak) : "") + "&v=" + c(d) + "&ref=" + c(b.referrer) + "&rm=" + (new Date).getTime();
                    Fa(f)
                },
        ...
        var Ga = 5 === $(".w .crumb a").length && /m.motif.me\/products\/(\d*)-(\d*)-(\d*).html[\w\W]*?e.motif.me\/(\d*).html/.exec($(".w .crumb").html()); (window.pageConfig && window.pageConfig.product && window.pageConfig.product.cat || Ga) && m.tracker.ngloader("item.010001", {
